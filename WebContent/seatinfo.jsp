<%-- 
    Document   : seatinfo
    Created on : 24-giu-2020, 17.30.09
    Author     : anton
--%>
...
<html>
    ...
    <body>
        ...
        <fieldset style="width: 180px">
            ...
            <label>Client ID: </label> <jsp:getProperty name="info" property="idclient" /><br/>
            ...
            <label>Available: </label> <jsp:getProperty name="info" property="available" /><br/>
        </fieldset><br/>
